...
uint256 hashGenesisBlock("0x5b2c505368e5ecfc3a12c074120c03f277b67e145cde48ba31eff496a8f264f5");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // CornerstoneCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "CornerstoneCoin Signed Message:\n";
...
{
    // CornerstoneCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight == 1){
        nSubsidy = nSubsidy * 10618181800 * 1  / 100 / 10000;
     }
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // CornerstoneCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // CornerstoneCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // CornerstoneCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5b2c505368e5ecfc3a12c074120c03f277b67e145cde48ba31eff496a8f264f5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1397849455;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087871746;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CornerstoneCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CornerstoneCoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running CornerstoneCoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CornerstoneCoinMiner terminated\n");
        throw;
    }
}
